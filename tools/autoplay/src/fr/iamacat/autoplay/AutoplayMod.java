 ...
 * the kill spot. A missing pig, a breached cap, or a missing carrier
...
public class AutoplayMod {
     ...
     * pigs, the bridge owns the bound — a drift here fails the proof
     ...
     * the pure SpawnJob and landed by the bridge sink.
     */
